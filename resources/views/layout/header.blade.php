<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-gray-800 dark:text-gray-200">
        <!-- Mobile hamburger -->
        ...
        <div class="flex justify-center flex-1 lg:mr-32">
            <div class="relative w-full max-w-xl mr-6 font-bold text-gray-800 dark:text-gray-200">
                @yield('title')
            </div>
            <div class="relative w-full max-w-xl mr-6 font-bold text-gray-800 dark:text-gray-200">
                Senin, 12 Oktober 2023, 10:15:13
            </div>
        </div>
