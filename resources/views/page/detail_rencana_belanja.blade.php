    ...
    <div class="container bg-white mb-5">
        <div class="container">
            ...
            <div class="d-flex justify-content-around">
                <button type="button" class="btn btn-rounded btn-danger mb-3">Tolak Rencana Belanja</button>
                <button type="button" class="btn btn-rounded btn-success mb-3">ACC Rencana Belanja</button>
            </div>
        </div>
